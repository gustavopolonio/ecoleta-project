...
This project was made to connect students and teachers. A teacher can register his schedules and costs per class and the students can find the available classes 
of many subjects. It's full responsive, has mobile-first approach and doesn't has functionality yet.

This project ideia was taken from [Rocketseat](https://rocketseat.com.br/) NLW and is part of my personal portfolio, so I would appreciate if you provide me any feedback about the ideia, code, structure or anything you could report to make me a better developer.

Feel free to use the Proffy Web as you wish, either to study or make improvementes!

You can check out this project in action clicking [here](https://gustavopolonio.github.io/proffy-web/).
...
```
git clone https://github.com/gustavopolonio/proffy-web.git
```
...
``` 
git clone git@github.com:gustavopolonio/proffy-web.git
```
</br>
...
This project is under the MIT license. See the [license](https://github.com/gustavopolonio/proffy-web/blob/master/LICENSE) for more informations.
